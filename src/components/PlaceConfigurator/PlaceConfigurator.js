        ...
        <form onSubmit={handleSubmit}>
          <MDBox display="flex" flexDirection="column" gap={{ xs: 1.5, sm: 2 }}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, ["Post Summary"]: e.target.value }))
              }
              InputLabelProps={{
                sx: { color: "#fff", "&.Mui-focused": { color: "#fff" } },
              }}
            ...
            <MDBox display="flex" gap={2}>
              <TextField
                ...
                value={form.Ranking}
                onChange={(e) =>
                  setForm((f) => ({ ...f, Ranking: e.target.value }))
                }
                InputLabelProps={{
                  sx: { color: "#fff", "&.Mui-focused": { color: "#fff" } },
                }}
              ...
              <TextField
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, ["Average Costs"]: e.target.value }))
                }
                InputLabelProps={{
                  sx: { color: "#fff", "&.Mui-focused": { color: "#fff" } },
                }}
                    ...
                    <InputAdornment position="start">
                      <span
                        ...
                        onClick={(e) => {
                          ...
                          const inputRoot = e.currentTarget.closest(
                            ".MuiOutlinedInput-root"
                          );
