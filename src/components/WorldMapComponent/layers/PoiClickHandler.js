// src/components/WorldMapComponent/layers/PoiClickHandler.js
...
export default function PoiClickHandler({ map, accessToken, onPoiClick }) {
  useEffect(() => {
    ...
    // Try to handle a Mapbox feature click or fallback
    ...
    // Attach to Mapbox POI layers when available
    ...
    // Mobile fallback: listen for touchend if canvas exists
